  ...
  >
    ...
    >
      <div class="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
        ...
        >
          Transform existing spaces<br />
          into <span class="text-[#c9b99a]">modern conversions</span>
        </h1>

        <!-- Buttons -->
        <div class="flex shrink-0 flex-wrap items-center gap-2.5 sm:gap-3">
          <!-- Latest Conversions -->
          <NuxtLink
            to="/projects"
...
const heroImageUrl = '/images/services/conversionshero.png'
</script>