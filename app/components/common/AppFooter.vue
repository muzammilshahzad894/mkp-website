<template>
  <footer class="font-sans text-white">
    <div class="bg-[#1B1B1B]">
      <!-- CTA: image + overlay + fade into footer -->
      <section
        class="relative flex flex-col overflow-hidden h-[700px]"
      ...
      >
        ...
        <div class="absolute inset-0 bg-black/40" role="presentation" />
        ...
        <div
          class="relative z-[1] mx-auto flex w-full max-w-[min(100%,85vw,1400px)] flex-1 flex-col items-center px-5 pb-24 pt-28 text-center sm:px-8 sm:pb-28 sm:pt-32 md:px-10 md:pb-32 md:pt-36 lg:pb-36 lg:pt-40 mt-20"
        >
          <div
            class="flex w-full flex-col items-center gap-9 md:gap-10 lg:gap-11"
          >
            <div
              class="flex w-full min-w-0 justify-center overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
            >
              <!-- CHANGE 2: Heading size reduced — was 58px/64px, now 42px/46px -->
              <h2
                id="footer-cta-heading"
                class="font-abaya whitespace-nowrap text-center font-abhaya font-bold uppercase leading-[1.2] tracking-normal text-white text-[1rem] sm:text-[clamp(1.3rem,2.8vw,2.4rem)]"
              >
            ...
            >
              Bring your vision to life with MKPDesign. From the first sketch to
              the final sign-off, we manage the details so you don't have to.
              Whether it's a loft conversion, modern extension or full
              renovation, let's start the conversation and create a space you'll
              love.
            </p>
            <div class="pt-1">
              <NuxtLink
      ...
      <!-- Main footer: brand left + nav columns pushed to right -->
      <div
        class="mx-auto w-full max-w-[min(100%,85vw,1400px)] px-5 pb-16 pt-10 sm:px-8 sm:pb-16 sm:pt-12 md:px-10 md:pb-20 lg:pt-14"
      >
        <div class="flex flex-col gap-12 lg:flex-row lg:items-stretch lg:gap-0">
          <!-- Brand column: fixed width, does NOT grow -->
          <div class="w-full shrink-0 text-left lg:w-[260px] lg:min-w-[260px]">
            <NuxtLink
              to="/"
            ...
            >
              MKPDesign – delivering innovative architecture and design
              solutions across London &amp; Surrey. Connect with us for expert
              guidance and project inspiration.
            </p>
          </div>

          <!-- CHANGE 3: Nav columns — margin-left:auto pushes them to the far right -->
          <div class="flex min-w-0 flex-col gap-10 font-poppins lg:ml-auto">
            <div
